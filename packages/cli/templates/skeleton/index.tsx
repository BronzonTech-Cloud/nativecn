...
export const Skeleton = ({
  ...
  useEffect(() => {
    // Only set up animation if pulse prop is true
    if (pulse && animatedValueRef.current) {
  ...
  }, [pulse]); // Only depend on pulse prop
  ...
  // Combine all styles
  const combinedStyle = pulse && Platform.OS !== 'web' ? [baseStyle, animatedStyle] : baseStyle;
  ...
  }, [pulse, baseColor, highlightColor, mode]);

  // Use the appropriate View component
  return Platform.OS === 'web' && pulse ? (
